...
<ul class="pagination">
    ...
    @else
        <li class="waves-effect"><a href={{$Practicas->url(1)}}><i class="material-icons">fast_rewind</i></a></li>
    ...
    @else
        ...
        <li class="waves-effect"><a href={{$Practicas->url($TotalPaginas)}}><i class="material-icons">fast_forward</i></a></li>
    @endif
</ul>