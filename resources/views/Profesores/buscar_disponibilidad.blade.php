...
@section('body')
<div class="container">
  <form method="POST" action="/buscar_disponibilidad_profesores">
    @csrf
    ...
    <div class="card-panel center">
      <h5 class="center-align black-text text-darken-2">Formulario De Busqueda</h5>
      <!-- <div class="row">
