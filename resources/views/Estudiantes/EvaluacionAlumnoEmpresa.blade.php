...
@section('scripts')
  ...
  @if(empty(Auth::user()->PostulacionPractica->where('estado','Aceptada')->first()->encurso->first()||Auth::user()->PostulacionPractica->where('estado','Confirmada')->first()->encurso->first()))
